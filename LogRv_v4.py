...
class CallFlowDiagram(QGraphicsView):
    ...
    def __init__(self, parent=None, main_window=None):
        ...
        self.main_window = main_window  # MODIFIED: Store reference to SipAnalyzerApp
    ...
    def wheelEvent(self, event):
        ...
        if self.main_window:  # MODIFIED: Use main_window for status_bar
    ...
    def display_call_flow(self, call_flow, selected_index=None):
        ...
        for i, msg in enumerate(filtered_flow):
            ...
            seq_text.setPos((x1 + x2) / 2 - 20, y - 25)
            seq_bg = QGraphicsRectItem(seq_text.boundingRect().adjusted(-2, -2, 2, 2))
            ...
            annotation_icon.setPos(text.pos().x() + text_width + 5, y - 25)
            annotation_icon.setVisible(bool(msg['annotation']))
            annotation_icon.setToolTip(msg['annotation'] if msg['annotation'] else "")
...
class SipAnalyzerApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.call_flow_diagram = CallFlowDiagram(main_window=self)  # MODIFIED: Pass self as main_window
